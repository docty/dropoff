      					...
      					<form className="checkout-form" method="POST" action="/order">
      						...
      						<div className="row address-inputs">
      							<div className="col-md-12">
      								<input type="text"  name="address" placeholder="Address" onChange={this.props.onValueChange}/>
      								<input type="text"  name="region"  placeholder="Region" onChange={this.props.onValueChange}/>
      								<input type="text"  name="country" placeholder="Country" onChange={this.props.onValueChange}/>
      							</div>
      							<div className="col-md-6">
      								<input type="text" name="number" placeholder="Phone Number" onChange={this.props.onValueChange}/>
      							</div>
      							<div className="col-md-6">
      								<input type="text" name="email"   placeholder="Email Address" onChange={this.props.onValueChange}/>
      							</div>
      						</div>
