          ...
          return(
            <div key={value.id}>
                  <div className="values">
                     ...
                     <h3 className="p-price">GHC {value.price} </h3>
                  ...
                  <div id="accordion" className="accordion-area">
                    ...
                    <div className="panel">
                      <div className="panel-header" id="headingTwo">
                        <button className="panel-link" data-toggle="collapse" data-target="#collapse2" aria-expanded="false" aria-controls="collapse2">card details </button>
                      </div>
